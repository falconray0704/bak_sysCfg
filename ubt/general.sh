...
init_operation_dirs_func()
{
	...
	sudo chown -R $USER:$USER /opt/etmp
...
case $1 in
    ...
    grpcUpdate) echo "Updating grpc ..."
        ...
        install_Latest_grpc
        ;;
    fetchBoost) echo "Fetching boost ..."
        fetch_boost_func
        ;;
    buildBoost) echo "Building boost ..."
        deploy_general_repo_pkgs
        build_boost_without_install_func
        ;;
    installBoost) echo "Installing boost ..."
        install_boost_src_func
        ;;
    deployBoost) echo "Deploying boost ..."
        deploy_general_repo_pkgs
        deploy_boost_without_install_func
        ;;
