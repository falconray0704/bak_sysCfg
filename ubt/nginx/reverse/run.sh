...
NGINX_PROXY_REVERSE_ROOT_DATAS="${NGINX_PROXY_REVERSE_ROOT}/datas"
NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY="${NGINX_PROXY_REVERSE_ROOT_DATAS}/nginx_proxy"
NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY_CONF_D="${NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY}/conf.d"

deploy_func()
{
    sudo mkdir -p ${NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY_CONF_D}
    ...
    cp ./nginx.tmpl ${NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY_CONF_D}/

}

launch_services_func()
{
    export NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY_CONF_D="${NGINX_PROXY_REVERSE_ROOT_DATAS_NGINXPROXY_CONF_D}"
